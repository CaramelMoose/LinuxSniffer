...
from LinuxSniffinterface import LinuxSniffinterface
...
class LinuxSniffGUI(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def init_interface(self):
        self.interfaceSniffer = LinuxSniffinterface()
    ...
    def bind_action(self):
        ...
        self.actionSave_db.triggered.connect(self.savetodb)
    ...
    def add_packet(self, pkt):
        ...
        item.setText(4, pkt.proto)
        item.setText(5, pkt.info)
    ...
    def about(self):
        QtGui.QMessageBox.about(self, "About", "LinuxSniffer is created by Nikita Kovalenko.")

def main():
    app = QtGui.QApplication(sys.argv)  # A new instance of QApplication
    mainWin = LinuxSniffGUI()
    mainWin.show()
    app.exec_()
